...
public class Main {
  ...
  private static void addNumbersAndWords(final Map<String, List<String>> numbers_and_words, final String number, final String word) {
  ...
  private static void getMatchesForNumber(final String number,
